...
internal actual object PlayerSettingsStorage {
    ...
    actual fun loadAutoCropEnabled(): Boolean? = loadBoolean(autoCropEnabledKey)
    actual fun saveAutoCropEnabled(enabled: Boolean) = saveBoolean(autoCropEnabledKey, enabled)
